...
docker run -d --name goalService --network milestonenetwork -e DBADDR=milestone-mongo:27017 ejacobson96/progress
...
-e DBADDR=milestone-mongo:27017 -e SESSIONKEY=production -e MESSAGESSVCADDR=messagingService:80 -e GOALSSVCADDR=goalService:80 ejacobson96/milestoneapi
